    ...
    <>
      ...
      <nav className="bg-white border-b border-gray-200 pb-2">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-stretch sm:items-center justify-between">
          <button className="bg-[#35AFA0] text-white flex items-center justify-center sm:justify-start gap-2 px-4 sm:px-6 py-3 uppercase font-semibold text-sm w-full sm:w-auto rounded-4xl">
          ...
          <ul className="flex flex-wrap justify-center sm:justify-end items-center gap-6 px-4 py-3 sm:py-0 text-[#3E445A] uppercase font-semibold text-sm">
            <li className="bg-[#F0FAFF] text-[#35AFA0] px-4 py-2 rounded-3xl">
              <Link to="/">Home</Link>
            </li>
            <li>
              <Link to="/shop" className="hover:text-[#35AFA0]">
                Shop
              </Link>
            </li>
            <li>
              <Link to="/shop" className="hover:text-[#35AFA0] flex items-center gap-1">
            ...
            <li>
              <Link to="/blog" className="hover:text-[#35AFA0]">Blog</Link>
            </li>
            <li>
              <Link to="/contact-us" className="hover:text-[#35AFA0]">Contact Us</Link>
            </li>
          </ul>
        </div>
      </nav>
