                        ...
                        <section>
                            ...
                            <div className="absolute inset-0">
                                <div className="absolute top-8 lg:top-15 left-4 lg:left-10">
                                    ...
                                    <Link to={'/shop'}>
                                        <button className="w-[100.13px] cursor-pointer h-[34px] mt-3 lg:mt-5 rounded-[30px] border border-[#233A95] bg-[#233A95] hover:bg-[#1c2f78] transition-colors duration-300 font-medium font-inter text-[12px] leading-[18px] tracking-[-0.1px] align-middle text-white">Shop Now</button>                                    </Link>
                                </div>
                            </div>
                        </section>
                    </section>
                        ...
                        <section>
                            ...
                            <div className="absolute inset-0">
                                <div className="absolute top-8 lg:top-15 left-4 lg:left-10">
                                    ...
                                    <Link to={'/shop'}>
                                        <button className="w-[100.13px] h-[34px] rounded-[30px] border mt-3 lg:mt-5 cursor-pointer border-[#ED174A] bg-[#ED174A] opacity-100 hover:bg-[#c9103e] transition-colors duration-300 font-medium font-inter text-[12px] leading-[18px] tracking-[-0.1px] align-middle text-white">Shop Now</button>                                    </Link>
                                </div>
                            </div>
                        </section>
                    </section>
